...
import enquiryHero from '../../assets/ENQUIRY FORM.png';
const EnquiryHero: React.FC = () => {
  return (
    <section className="relative w-full  overflow-hidden border-y-[3px] border-[#8B7344]">
      {/* Background Image */}
      <img
        src={enquiryHero}// Ensure this is the correct path to your image
        alt="About Us hero – bridal hands with bangles"
      ...
      {/* Top Gold Line Detail (Optional extra polish) */}
